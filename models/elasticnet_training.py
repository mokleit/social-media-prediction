...
elasticnet_best_results_txt = 'elasticnet_best_results.txt'
with open(elasticnet_best_results_txt, 'w') as f:
    print(search_grid.best_params_, file=f)
    print(search_grid.best_score_, file=f)

elasticnet_pickle = 'elasticnet_pickle.pkl'
with open(elasticnet_pickle, 'wb') as file:
